...
SR_COLS = {
    ...
    "big_wall": st.column_config.TextColumn(
        ...
        help="**THE BIGGER-FRAME WALL YOUR PAIR CANNOT SEE.** The setup, sup/res and headroom "
             "all read only the TWO frames of your horizon (e.g. 1h + 4h). But a long can sit "
             "right under a resistance on a frame ABOVE the pair that it never looked at — you "
             "buy, hit the big level, and it reverses. This column shows the nearest DEFENDED "
             "(≥2-touch) wall from EVERY frame above your pair, in your trade's direction: a "
             "ceiling above a long, a floor below a short.\n\n"
             "Which frames, by horizon: **Intraday** (15m/1h) → 2h, 4h, 1D, 1W · **BTST** "
             "(1h/4h) → 1D, 1W · **Swing** (4h/1D) → 1W · **Positional** → none (top frame). "
             "The frame label travels with the level, so `4h 250 ×3` vs `1D 250 ×5` tells you "
             "how big it is.\n\n"
