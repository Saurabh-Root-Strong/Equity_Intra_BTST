...
DELIV_COLS = {
    "deliv 5wk": st.column_config.TextColumn(
        ...
        help="THE DELIVERY TREND — turnover-weighted delivery % for the CURRENT week first, then "
             ...
             "HOW TO READ '19*4d, 17, 13, 16, 36  −35%': the FIRST number is this week and the "
             "rest go BACKWARDS in time. '*4d' means the week is still forming and has 4 trading "
             "days in it so far — the noisiest number in the cell. '−35%' is where that current "
             "reading sits versus the stock's own long-run norm. Here delivery is running a "
             "third below normal after collapsing from 36% five weeks ago — distribution.\n\n"
